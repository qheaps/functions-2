...
// CODE HERE
printer = (param1, param2) => console.log(`The first parameter is ${param1}. The second parameter is ${param2}`)
...
// CODE HERE
function pricesPlusTax(priceArr, callback) {
    for(let i = 0; i < priceArr.length; i++) {
        totalCost.push(priceArr[i] + (priceArr[i] * .2))
    }
    return callback(totalCost)
}

uLess = totalCost => console.log(`The new array plus tax - ${totalCost}`)
